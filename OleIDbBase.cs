...
namespace DBUtil
{
    public abstract class OleIDbBase : IDbAccess
    {
        ...
        #region 获得分页的查询语句 public virtual string GetSqlForPageSize(string tableName, string[] selectColumns, int PageSize, int PageIndex, string strWhere, string strOrder)
        /// <summary>
        /// 获得分页的查询语句
        /// </summary>
        /// <param name="tableName">表名</param>
        ...
        #region 获得分页的查询语句 public virtual string GetSqlForPageSize(string selectSql, string strOrder, int PageSize, int PageIndex)
        /// <summary>
        /// 获得分页的查询语句
        /// </summary>
